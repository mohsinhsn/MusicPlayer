...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mohsinhsn/MusicPlayer)

NOTE: Make sure you have started a VoiceChat in your Group before deploying.
### Deploy to VPS

```sh
git clone https://github.com/mohsinhsn/MusicPlayer
cd MusicPlayer
...
Connect Me On [Telegram](https://t.me/monstar_0)
